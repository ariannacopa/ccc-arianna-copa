...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateCircleSize() {
        ...
        console.log(`🔋 ${isPersonalMode ? 'TUA' : 'GIORGIA'} batteria: ${batteryToUse}% → ${size}px`);
    }
...
if (emotion === 'hungry') {
    ...
    const borderColor = isNegativeMode ? 'white' : 'black';
    ...
    if (toggleButton && widgetBody && feelingText) {
        toggleButton.addEventListener('click', function() {
            ...
            if (!isPersonalMode) {
                feelingText.textContent = "Today Giorgia is feeling ";
    ...
    setInterval(() => {
        ...
        console.log(` GIORGIA batteria: ${friendBatteryPercent}% → ${calculateCircleSize(friendBatteryPercent)}px`);
